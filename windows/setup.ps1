...
Write-Host "Done Configuring the Base Windows Installation"


Write-Host "Installing Programs"

Set-ExecutionPolicy Bypass -Scope Process -Force; iwr https://chocolatey.org/install.ps1 -UseBasicParsing | iex
choco install git.install --params "/WindowsTerminal /NoGuiHereIntegration"
choco install dashlane firefox slack filezilla discord vscode steam spotify microsoft-windows-terminal jre8 7zip notepadplusplus vlc nvm zoom yarn postman listary dbeaver docker cpu-z blender googlechrome jetbrainstoolbox dotnet nextcloud-client uplay
...
Write-Host "Download Ubuntu from the Microsoft Store"